...
<head>
    ...
    <title inertia><?php echo e(config('app.name', 'Alpha eLibrary')); ?></title>
    ...
    <script>
        ...
        window.initialLanguage = <?php echo json_encode($page['props']['locale'] ?? 'km', 15, 512) ?>;
    </script>
...
<?php /**PATH D:\My project\alpha eLibrary\resources\views/app.blade.php ENDPATH**/ ?>